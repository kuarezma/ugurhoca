...
const config = [
  ...
  ...nextVitals,
  {
    ...
    rules: {
      ...
      // Nesnel kurallar error: ihlal sayısı 0 iken yükseltildi (2026-09-10),
      // yeni <img>/altsız görsel CI'da kırar. Davranışsal kurallar
      // (click-events, static/noninteractive-interactions) oyunlardaki özel
      // etkileşimler nedeniyle warn kalır — P2 a11y'de vaka bazlı ele alınır.
