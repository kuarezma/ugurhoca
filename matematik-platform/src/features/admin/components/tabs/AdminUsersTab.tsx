...
export default function AdminUsersTab({
      ...
      <div className="mt-3 flex flex-col gap-2 text-sm text-slate-600 dark:text-slate-400 sm:flex-row sm:items-center sm:justify-between">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="self-start rounded-lg px-2.5 py-1 text-xs font-semibold text-violet-600 dark:text-violet-300 transition-colors hover:bg-violet-500/10 hover:text-violet-700 dark:hover:text-violet-200"
          >
            Filtreleri temizle
          </button>
        )}
  ...
  const renderStudentCard = (user: AdminUser, index: number) => {
    ...
    return (
      <div
        key={user.id}
        className="glass rounded-2xl p-4 sm:p-5 card-hover animate-slide-up overflow-hidden border border-slate-200/80 dark:border-white/10 hover:border-violet-500/40 dark:hover:border-white/20 transition-all duration-300 bg-white/80 dark:bg-slate-900/60 shadow-sm dark:shadow-md"
        ...
        <div className="flex min-w-0 flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 items-center gap-3 sm:gap-4">
            ...
            <div className="min-w-0">
              <div className="flex min-w-0 items-center gap-2">
                <h3 className="truncate text-base sm:text-lg font-bold text-slate-900 dark:text-white">
                  {user.name || 'İsimsiz'}
                </h3>
                {user.is_favorite && (
                  <span className="inline-flex shrink-0 items-center gap-1 rounded-full border border-amber-400/30 bg-amber-400/10 px-2 py-0.5 text-[10px] font-bold text-amber-600 dark:text-amber-300">
                    <Star className="h-3 w-3 fill-current" />
                    Favori
                  </span>
                )}
              </div>
              <p className="break-all text-slate-600 dark:text-slate-400 text-sm">{user.email}</p>
          ...
          <div className="grid grid-cols-1 gap-2 sm:flex sm:flex-wrap sm:items-center sm:justify-end">
            <button
              ...
              className={`justify-center px-3.5 py-2 rounded-xl text-xs sm:text-sm font-semibold flex items-center gap-1.5 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] border ${
                user.is_favorite
                  ...
                  : 'bg-slate-100 dark:bg-white/5 text-slate-700 dark:text-slate-300 hover:bg-slate-200/70 dark:hover:bg-white/10 hover:text-amber-600 dark:hover:text-amber-300 border-slate-200 dark:border-white/10'
              }`}
            ...
            <button
              ...
              className="justify-center px-3.5 py-2 bg-cyan-50 dark:bg-cyan-500/15 border border-cyan-200 dark:border-cyan-500/25 text-cyan-700 dark:text-cyan-300 rounded-xl hover:bg-cyan-100 dark:hover:bg-cyan-500/25 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] text-xs sm:text-sm font-semibold flex items-center gap-1.5"
            >
            ...
            <button
              ...
              className="justify-center px-3.5 py-2 bg-emerald-50 dark:bg-emerald-500/15 border border-emerald-200 dark:border-emerald-500/25 text-emerald-700 dark:text-emerald-300 rounded-xl hover:bg-emerald-100 dark:hover:bg-emerald-500/25 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] text-xs sm:text-sm font-semibold flex items-center gap-1.5"
            >
            ...
            <button
              ...
              className="justify-center px-3.5 py-2 bg-violet-50 dark:bg-brand-primary/20 border border-violet-200 dark:border-brand-primary/30 text-violet-700 dark:text-violet-200 rounded-xl hover:bg-violet-100 dark:hover:bg-brand-primary/30 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] text-xs sm:text-sm font-semibold flex items-center gap-1.5 shadow-sm"
            >
