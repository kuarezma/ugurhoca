...
export const AdminDiagnosticsCard: React.FC<AdminDiagnosticsCardProps> = ({
  ...
  return (
    <div className="mb-6 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200/80 dark:border-white/10 shadow-md dark:shadow-xl backdrop-blur-md overflow-hidden transition-all duration-300">
      {/* Summary Header */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-sm font-bold text-slate-900 dark:text-white tracking-tight">Sistem Sağlığı & Entegrasyonlar</span>
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-semibold bg-emerald-100 dark:bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-500/25">
        ...
        <div className="flex items-center gap-2 ml-auto">
          {onRefresh && (
            <button
              ...
              className="p-1.5 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white rounded-lg hover:bg-slate-200/70 dark:hover:bg-slate-700/60 transition-colors disabled:opacity-50"
          ...
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 transition-colors"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 p-4 bg-slate-50/50 dark:bg-slate-900/60">
        ...
        <div className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-slate-800/50 border border-slate-200/80 dark:border-slate-700/50 shadow-sm dark:shadow-none">
          ...
          <div>
            <div className="text-xs text-slate-500 dark:text-slate-400 font-medium">Canlı Ders Motoru</div>
        ...
        <div className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-slate-800/50 border border-slate-200/80 dark:border-slate-700/50 shadow-sm dark:shadow-none">
          ...
          <div>
            <div className="text-xs text-slate-500 dark:text-slate-400 font-medium">Kayıtlı Öğrenci</div>
      ...
      {isExpanded && (
        <div className="px-5 py-4 border-t border-slate-200/80 dark:border-slate-800/80 bg-slate-50/70 dark:bg-slate-950/40 animate-in fade-in slide-in-from-top-2 duration-200">
          <h4 className="text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider mb-3">
            Bekleyen İş Kuyrukları ve Teşhis Verileri
          </h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {/* Pending Worksheets */}
            <div className="flex items-center justify-between p-3.5 rounded-xl bg-white dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-700/40 shadow-sm dark:shadow-none">
              <div className="flex items-center gap-2.5">
                <FileCheck2 className="w-4 h-4 text-amber-500 dark:text-amber-400" />
                <div>
                  <div className="text-xs font-semibold text-slate-800 dark:text-slate-200">Onay Bekleyen Aday Testler</div>
                  <div className="text-[11px] text-slate-500 dark:text-slate-400">Yandex / Drive kaynağından taranan yeni testler</div>
                </div>
              </div>
              <span
            ...
            <div className="flex items-center justify-between p-3.5 rounded-xl bg-white dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-700/40 shadow-sm dark:shadow-none">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <div className="text-xs font-semibold text-slate-800 dark:text-slate-200">Okunmamış Öğrenci Mesajları</div>
                  <div className="text-[11px] text-slate-500 dark:text-slate-400">Cevap bekleyen doğrudan öğrenci soruları</div>
                </div>
              </div>
              <span
                className={`px-2.5 py-1 rounded-full text-xs font-bold ${
