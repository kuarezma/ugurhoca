        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 pb-8 border-b border-white/5">
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-1.5 text-xs text-slate-400">
              <li>
                <Link href="/icerikler" className="hover:text-brand-primary-soft transition">
                  Ders Notları & PDF'ler
                </Link>
              </li>
              <li>
                <Link href="/testler" className="hover:text-brand-primary-soft transition">
                  İnteraktif Testler
                </Link>
              </li>
              <li>
                <Link href="/programlar" className="hover:text-brand-primary-soft transition">
                  LGS & YKS Rehberliği
                </Link>
              </li>
              <li>
                <Link href="/oyunlar" className="hover:text-brand-primary-soft transition">
                  Matematik Oyunları
                </Link>
              </li>
              <li>
                <Link href="/canli-ders" className="hover:text-brand-primary-soft transition">
                  Canlı Ders Salonu
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-1.5 text-xs text-slate-400">
              <li>
                <Link href="/gizlilik" className="hover:text-brand-primary-soft transition">
                  Gizlilik Politikası
                </Link>
              </li>
              <li>
                <Link href="/kvkk" className="hover:text-brand-primary-soft transition">
                  KVKK Aydınlatma Metni
                </Link>
              </li>
              <li>
                <Link href="/gizlilik#cerezler" className="hover:text-brand-primary-soft transition">
                  Çerez Tercihleri
                </Link>
              </li>
              <li>
