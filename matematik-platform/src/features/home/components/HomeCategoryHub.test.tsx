...
describe('HomeCategoryHub', () => {
  ...
  it('renders 3 main category tabs', () => {
    ...
    expect(screen.getByRole('tab', { name: /Dersler/i })).toBeInTheDocument();
    expect(screen.getByRole('tab', { name: /Oyun/i })).toBeInTheDocument();
    expect(screen.getByRole('tab', { name: /Araçlar/i })).toBeInTheDocument();
  });
  ...
  it('switches to games tab and shows games content and speed drill trigger', () => {
    ...
    const gamesTab = screen.getByRole('tab', { name: /Oyun/i });
  ...
  it('switches to tools tab and shows tools grid excluding games', () => {
    ...
    const toolsTab = screen.getByRole('tab', { name: /Araçlar/i });
