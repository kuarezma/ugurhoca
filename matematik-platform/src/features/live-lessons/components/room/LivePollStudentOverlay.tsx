              ...
              {activeQuestion.options.map((opt, idx) => {
                ...
                return (
                  <button
                    key={opt + idx}
                    type="button"
                    disabled={myChoice !== null || interactionLocked}
                  ...
                  >
                    {/* Live Percent Progress Bar (when answered) */}
                    {myChoice !== null && stat && (
                      <div
                        className="absolute inset-y-0 left-0 bg-violet-500/15 transition-all duration-500"
            ...
            {myChoice !== null && (
              <div className="flex items-center justify-between pt-1 text-xs text-slate-400">
                ...
                <span className="flex items-center gap-1 text-[11px] text-slate-500">
                  ...
                  Toplam {Object.keys(answers).length} Yanıt
                </span>
              </div>
            )}
          </div>
