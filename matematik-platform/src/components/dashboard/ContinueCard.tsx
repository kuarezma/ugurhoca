...
import { ContinueState } from "@/types/dashboard";
...
export default function ContinueCard({ state }: ContinueCardProps) {
  return (
    <motion.section
      ...
      className={`relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br ${state.accentClass} p-6`}
    >
      ...
      <div className="relative">
        ...
        <h2 className="text-2xl font-black text-white">{state.title}</h2>
