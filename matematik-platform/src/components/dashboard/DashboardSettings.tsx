...
export default function DashboardSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* KVKK / Hesap Kapatma (Tehlikeli Bölge) */}
      <motion.section
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.24 }}
        className="rounded-3xl border border-rose-500/20 bg-rose-500/5 p-6 sm:p-8"
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-rose-600/20 hover:bg-rose-600 border border-rose-500/30 px-4 py-2.5 text-xs font-bold text-rose-200 hover:text-white transition shadow-md shrink-0"
          >
